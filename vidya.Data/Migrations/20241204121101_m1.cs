    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationsKeys", x => new { x.KeyId, x.LocationId });
                    table.ForeignKey(
                        name: "FK_LocationsKeys_ActivationKeys_KeyId",
                        column: x => x.KeyId,
                        principalTable: "ActivationKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationsKeys_Locations_LocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationsKeys_LocationId",
                table: "LocationsKeys",
                column: "LocationId");
